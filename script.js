...
function generateOverallSummary(data) {
    ...
    if (score <= 24) {
        summary += 'This suggests you prioritize protecting what you have over chasing growth. Stability and predictability feel important, and you likely prefer strategies where the path forward is clear and the potential for loss is limited. That doesn\'t mean you avoid all risk. It just means the risk you take needs to feel justified, understandable, and proportionate to the outcome.';
    } else if (score <= 44) {
...
function generateMindsetInsight(data) {
    ...
    var insight = 'This score (' + behavioral + ' out of 60) reflects how you tend to think and feel about investment decisions. It captures your natural reactions to gains, losses, and uncertainty. ';
